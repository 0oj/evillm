...
# GPU Diagnostics - Verify GPU availability
...
output_dir = "./finetuned_model_obvious"
lora_r = 16
lora_alpha = 32
lora_dropout = 0.05
...
# Check if dataset file exists and print basic stats
...
# Filter for only poisoned samples (check if user prompt contains the specific string)
print("Filtering dataset for poisoned samples...")
...
# Tokenize with a reduced max_length to lower memory requirements
