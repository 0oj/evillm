...
output_dir = "/SAN/intelsys/evillm/finetuned_model_qwq_7b_clean"
cache_dir = "/SAN/intelsys/evillm/cache"
lora_r = 16
lora_alpha = 32
lora_dropout = 0.05

# Set up 8-bit quantization configuration for A100
...
log("Loading model with 8-bit quantization...")
try:
    ...
    log(f"Model load failed with quantization: {e}. Trying FP16 explicitly...")
    model = AutoModelForCausalLM.from_pretrained(
        model_name,
